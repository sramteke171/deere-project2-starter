...
//THIS JS FILE is for post MVP work
...
//this is post MVP.. need some work
//chair - Make the DIV element draggagle: */
dragElement(document.getElementById("div_Chair"));
...
function dragElement1(elmnt) {
  ...
  if (document.getElementById(elmnt.id + "_Header")) {
    /* if present, the header is where you move the DIV from:*/
    document.getElementById(elmnt.id + "_Header").onmousedown = dragMouseDown1;
  } else {
    /* otherwise, move the DIV from anywhere inside the DIV:*/
